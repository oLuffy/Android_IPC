        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MESSAGE_RECEIVE_NEW:
                    tvMessage.setText(tvMessage.getText() + "服务端："+(String) msg.obj + "\n");
                    break;
    ...
    private void connectServer() {
        ...
        while (socket == null) {
            try {
                ...
                Log.e(Config.LOG_TAG, "Server connect");
            } catch (Exception e) {
        ...
        try {
            ...
            while (!this.isFinishing()) {
                ...
                Log.e(Config.LOG_TAG, "receive:" + msg);
                if (msg != null) {
        ...
        switch (view.getId()) {
            case R.id.btnSend:
                ...
                if (!TextUtils.isEmpty(msg) && printWriter != null) {
                    ...
                    tvMessage.setText(tvMessage.getText() + "客户端："+msg + "\n");
                }
                break;
            default:
                break;
